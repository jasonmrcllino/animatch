...
func _ready():
	...
	music_slider.value_changed.connect(func(value):
		...
		# Jika volume paling kecil, mute audionya biar ga kedengeran bocor

		if value <= -40:

			music_player.volume_db = -80 # Nilai paling senyap di Godot

		else:

			# Mainkan HANYA JIKA musiknya belum jalan, biar ga reset dari awal
